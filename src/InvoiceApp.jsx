            ...
            <div className="container">
                <div className="card my-3">
                    ...
                    <div className="card-body">
                        ...
                        <button className="btn btn-primary" onClick={changeEstatus}>
                            {!activeForm ? <FontAwesomeIcon icon={faPlus} /> : <FontAwesomeIcon icon={faMinus} />}
                            </button>

                        {!activeForm || <FormItemsView handler = {handlerAddItem} />}
                    </div>
                </div>
            </div>
        </>
